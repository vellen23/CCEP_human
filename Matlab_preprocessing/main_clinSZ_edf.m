...
% load labels
MP_label = importfile_MPlabels([path_patient '\infos\EL015_lookup.xlsx'], 'Channels');
BP_label = importfile_BPlabels([path_patient '\infos\EL015_lookup.xlsx'], 'Channels_BP');
...
TTL = round(stimlist.TTL/1024*500);
...
%     % notch - find which notch
    ...
    Fs2                 = 500;
    ppEEG               = resample(ppEEG',Fs2,Fs)';
    TTL_ds                  = round((stimlist.TTL(:))/(Fs/Fs2));