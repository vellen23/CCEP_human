...
class main:
    ...
    def plot_LL_BL_IPI_c(self, sc, c):
        ...
        print(self.labels_all[c])
        #LL_all      = pd.read_csv(self.path_patient + '/Analysis/Pharmacology/LL/LL_CR_' + StimChan + '.csv')
        LL_all = pd.read_csv(self.path_patient + '/Analysis/Pharmacology/LL/LL_Ph_PP_' + StimChan + '.csv')
        ...
        mx = np.max(data['LL PP norm'])
        grid        = sns.catplot(x="IPI", y='LL PP norm', hue="Condition", data=data, row='Int', kind="swarm",
