...
class main:
    ...
    def get_summary(self, con_trial, CC_summ, EEG_resp):
        ...
        con_summary.to_csv(summary_gen_path, index=False, header=True)
    ...
    def get_subnetworks(self, con_summary, parameters=['Sig', 'd', 'delay']):
        ...
        for par in parameters:
            ...
            for sc in np.unique(con_summary.Stim): # for each selected Stim Node, get the reponse nodes (Chan) and the edge weigths (par)
