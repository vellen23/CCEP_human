...
def compute_subj(subj, metric='LL'):
    ...
    if not 'SleepState' in con_trial_Ph:
        ...
        con_trial_Ph.loc[
            (con_trial_Ph.Sleep == 0) & (con_trial_Ph.Hour >= 9) & (con_trial_Ph.Hour < 15), 'SleepState'] = 'Wake_M'
        con_trial_Ph.loc[
            (con_trial_Ph.Sleep == 0) & (con_trial_Ph.Hour >= 15) & (con_trial_Ph.Hour < 21), 'SleepState'] = 'Wake_A'
        con_trial_Ph.loc[
    ...
    for rk in rank_sel:  # range(k0, k1 + 1):
        ...
        # sleepstate
        con_nmf.insert(5, 'SleepState', 'Wake_M')
        con_nmf.loc[(con_nmf.Sleep > 1) & (con_nmf.Sleep < 4), 'SleepState'] = 'NREM'
        con_nmf.loc[(con_nmf.Sleep == 4), 'SleepState'] = 'REM'
        con_nmf.loc[
            (con_nmf.Sleep == 0) & (con_nmf.Hour >= 9) & (con_nmf.Hour < 15), 'SleepState'] = 'Wake_M'
        con_nmf.loc[
            (con_nmf.Sleep == 0) & (con_nmf.Hour >= 15) & (con_nmf.Hour < 21), 'SleepState'] = 'Wake_A'
        con_nmf.loc[
            (con_nmf.Sleep == 0) & ((con_nmf.Hour < 9) | (con_nmf.Hour >= 21)), 'SleepState'] = 'Wake_N'
